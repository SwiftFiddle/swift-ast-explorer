...
function update(editor) {
    ...
    $.post('/update', json).done(function (data, xhr) {
...
function updateStructureTree() {
    $('\#structure').find('li').each(function (i, element) {
        ...
        $(this).mouseover(function (event) {
            ...
            if (data.token) {
                ...
                if (!target.attr('__tippy')) {
                    const kind =
                        `<span class='tooltip-title'>kind:</span><span style='font-family: "Menlo", sans-serif, monospace;'> ${data.token.kind}</span>`;
                    const leadingTrivia =
                        `<span class='tooltip-title'>leadingTrivia:</span><span style='font-family: "Menlo", sans-serif, monospace;'> ${data.token.leadingTrivia}</span>`;
                    const text =
                        `<span class='tooltip-title'>text:</span><span style='font-family: "Menlo", sans-serif, monospace;'> ${data.text}</span>`;
                    const trailingTrivia =
                        `<span class='tooltip-title'>trailingTrivia:</span><span style='font-family: "Menlo", sans-serif, monospace;'> ${data.token.trailingTrivia}</span>`;
                    const content =
                        `${kind}<br>${leadingTrivia}<br>${text}<br>${trailingTrivia}`;
