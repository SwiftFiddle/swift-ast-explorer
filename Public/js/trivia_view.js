...
export class TriviaView {
  ...
  <dt class="text-truncate" style="max-width: calc(40vw - 20px); margin-top: 8px;"><span class="badge annotation" style="width: auto; text-align: start;"><span class="bi bi-info-circle"></span><span class="mx-1">Trivia Attribution Rule</span></dt>
